...
Umbrella index for home-lab agent development, learning, and personal projects.
...
3. Create a new file or subfolder following the entry template in [`ai/instructions.md`](ai/instructions.md).
